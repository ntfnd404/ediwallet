...
import 'features/dds/data/models/dds_model.dart';
...
class DBProvider {
  ...
  Future<int> createTransaction(
      transaction_entity.Transaction newTransaction) async {
    // final db = database;
  ...
  Future getDDS(String id) async {
    ...
    return res.isNotEmpty
        ? DDSModel.fromJson(res.first as Map<String, String>)
        : Null;
  }
  ...
  Future<List> getAllDDS() async {
    ...
    return res.isNotEmpty
        ? res
            .map((dds) => DDSModel.fromJson(dds as Map<String, String>))
            .toList()
        : List<DDSModel>.empty();
  }
